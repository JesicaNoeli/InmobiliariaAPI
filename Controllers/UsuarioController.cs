...
namespace ProyectoInmobiliaria.Controllers
{
    ...
    public class UsuarioController : Controller
    {
        ...
        {
            Usuario aux  = repositorioUsuario.ObtenerPorId(id);
            string pass = aux.Clave; //guarda la clave actualpara no modificar por error

            try
            {
                if (ModelState.IsValid)
                {
                    if (pass != i.Clave) { //si no se cambio la clave no se hashea
                        ...
                        ModelState.AddModelError("", "Usuario Editado");
                    ...
                    {
                        int res = repositorioUsuario.Modificacion(i);
                        ModelState.AddModelError("", "Usuario Editado, La contraseña no cambia");
                       // TempData["Mensaje"] = "La contraseña no cambia";
                        return RedirectToAction(nameof(Index));
                    }
                    ...
                    {
                    ModelState.AddModelError("", "Error al Editar, Verifique si los datos son correctos");
